...
{
	/// <summary>
	/// A number of possible map types for static maps.
	/// Do not change the XmlEnum values!
	/// </summary>
	public enum GoogleMapType
	{
		[XmlEnum("roadmap")] Road,
		[XmlEnum("satellite")] Satellite,
		[XmlEnum("terrain")] Terrain,
		[XmlEnum("hybrid")] Hybrid
	}
}